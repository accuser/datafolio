...
export function Sun({ size = 15, color = "currentColor", strokeWidth = 2, style }: IconProps) {
  return (
    <svg {...a11y} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" style={style}>
...
export function Moon({ size = 15, color = "currentColor", strokeWidth = 2, style }: IconProps) {
  return (
    <svg {...a11y} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" style={style}>
      <path d="M21 12.8A9 9 0 1 1 11.2 3a7 7 0 0 0 9.8 9.8z" />
    </svg>
  );
}

export function Monitor({ size = 15, color = "currentColor", strokeWidth = 2, style }: IconProps) {
  return (
    <svg {...a11y} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" style={style}>
